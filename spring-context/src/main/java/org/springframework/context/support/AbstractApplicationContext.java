...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	...
	/**
	 * ApplicationEventMulticaster实例名称。
	 * <p>
	...
	/**
	 * Spring核心逻辑。
	 * <a href="https://blog.csdn.net/simba_1986/article/details/79282102">ApplicationContext容器启动refresh方法分析</a>
	 *
	...
	public void refresh() throws BeansException, IllegalStateException {
		synchronized (this.startupShutdownMonitor) {
			...
			//2. 让子类去刷新内部bean factory。
			// Tell the subclass to refresh the internal bean factory.
			ConfigurableListableBeanFactory beanFactory = obtainFreshBeanFactory();

			//准备bean factory，设置一些属性值。
	...
	protected void prepareRefresh() {
		...
		//1.2 初始化context environment对象中placeholder属性。
		// Initialize any placeholder property sources in the context environment.
		initPropertySources();

		//1.3 验证所有标记为required的属性是否满足要求
	...
	/**
	 * 按照给定order初始化并调用所有已注册BeanFactoryPostProcessor实例。
	 *
